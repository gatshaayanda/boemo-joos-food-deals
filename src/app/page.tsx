...
export default function Home(){
 ...
 const fallbackDeals:MenuItem[]=lateNightDeals.map((deal,index)=>({id:String(index),name:deal.name,price:deal.price,...("friend" in deal?{friendPrice:deal.friend}:{}),category:"Deal",description:"",available:true,preparationMinutes:0,sortOrder:index,section:"deal"}));
